...
export default function Cart() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-text/40 flex justify-end">
      <div className="bg-bg text-text font-body w-full sm:w-[500px] h-full overflow-y-auto p-8">
        <button
          onClick={closeCart}
          className="text-sm text-text/60 mb-4 cursor-pointer"
        >
          stäng
        </button>
        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center">
            <h1 className="text-2xl font-bold font-heading mb-4">Din varukorg</h1>
            <p>Varukorgen är tom.</p>
          </div>
        ) : (
          <>
            <h1 className="text-2xl font-bold font-heading mb-6">Din varukorg</h1>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text/60">${item.price.toFixed(2)}</p>
                    </div>
                  </div>
